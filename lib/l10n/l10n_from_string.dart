...
abstract class L10nStrings {
  ...
  static const info_noChangesFound = 'info_noChangesFound';
...
extension L10nFromString on String {
  String tr(BuildContext context) {
    switch (this) {
      ...
      case L10nStrings.info_alreadyAdded:
        return L10n.of(context)!.info_alreadyAdded;
      case L10nStrings.info_noChangesFound:
        return L10n.of(context)!.info_noChangesFound;
